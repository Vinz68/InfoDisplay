...
app.controller('MainCtrl', function ($scope, $timeout, QueueService) {
    var INTERVAL = 3000,
        slides = [
        { id: "image00", src: "./images/Slide0.JPG" },
        { id: "image01", src: "./images/Slide1.JPG" },
        { id: "image02", src: "./images/Slide2.JPG" },
        { id: "image03", src: "./images/Slide3.JPG" },
        { id: "image04", src: "./images/Slide4.JPG" }];
